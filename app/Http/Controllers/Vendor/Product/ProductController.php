...
class ProductController extends BaseController
{
    ...
    public function getListView(Request $request, $type): View
    {
        ...
        return view(Product::LIST[VIEW], compact('products', 'type', 'searchValue', 'brands',
            'categories','subCategories','subSubCategories', 'subCategory', 'subSubCategory', 'filters'));
    }
    ...
    public function getView(string|int $id): View|RedirectResponse
    {
        ...
        return view('vendor-views.product.view', compact('product', 'reviews', 'productActive', 'productColors', 'isActive','totalSellerProducts'));
    }
