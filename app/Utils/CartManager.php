...
class CartManager
{
    ...
    $noestVendorId = $product->added_by == 'admin' ? 0 : $product->user_id;
    ...
    return [
        ...
        'message' => $sellerShippingList && count($sellerShippingList) > 0
            ? translate('Please_select_shipping_method')
            : translate('Shipping_Not_Available_for_this_Shop'),
