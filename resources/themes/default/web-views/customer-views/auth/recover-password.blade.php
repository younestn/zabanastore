                ...
                @if($verification_by == 'email')
                    ...
                    <ol class="list-unstyled font-size-md p-0">
                        <li>
                            ...
                            {{ translate('enter_your_email_address') }}.
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            {{ translate('use_the_link_to_change_your_password_on_our_secure_website') }}.
                        </li>
                    </ol>
                @else
                    <p class="font-size-md">
                ...
                <div class="card py-2 mt-4">
                    <form class="card-body needs-validation" action="{{ route('customer.auth.forgot-password') }}"
                        ...
                        <div class="form-group">
                            <label for="recover-identity">
                                {{ $verification_by == 'email' ? translate('email') : translate('Phone') }}
                            </label>

                            <input class="form-control {{ $verification_by == 'phone' ? 'clean-phone-input-value' : '' }}"
                                   type="text"
                                   id="recover-identity"
                                   name="identity"
                                   required
                                   placeholder="{{ $verification_by == 'email' ? translate('enter_your_email') : translate('enter_your_phone_number') }}">
                        ...
                        @if($verification_by == 'phone' && $web_config['firebase_otp_verification'] && $web_config['firebase_otp_verification']['status'])
                        ...
                        <button class="btn btn--primary" type="submit">
                            {{ $verification_by == 'email' ? translate('send') : translate('send_OTP') }}
                        </button>
                    </form>
                </div>
            </div>
