...
<div class="border rounded bg-white">
    <div class="p-3 fs-12 d-flex flex-column gap-2">
        ...
        <div class="d-flex justify-content-between gap-2">
            ...
            <div>{{ webCurrencyConverter(amount: $refundDetailsSummery['product_price']) }}</div>
        </div>
        <div class="d-flex justify-content-between gap-2">
            <div class="text-muted text-capitalize">{{translate('product_discount')}}</div>
            <div>-{{ webCurrencyConverter(amount: $refundDetailsSummery['product_discount']) }}</div>
        </div>
        <div class="d-flex justify-content-between gap-2">
            <div class="text-muted">{{translate('vat')}}/{{translate('tax')}}</div>
            <div>{{ webCurrencyConverter(amount: $refundDetailsSummery['tax']) }}</div>
        </div>
        <div class="d-flex justify-content-between gap-2">
        ...
        <div class="d-flex justify-content-between gap-2">
            <div class="text-muted text-capitalize">{{translate('referral_discount')}}</div>
    ...
    <div class="d-flex justify-content-between gap-2 border-top py-2 px-3 fs-12">
        ...
        <div class="font-weight-bold">{{ webCurrencyConverter(amount: $refundDetailsSummery['total_refundable_amount']) }}</div>
    </div>
</div>
<div class="border rounded bg-white">
