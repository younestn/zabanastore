                        ...
                        <div class="d-flex justify-content-end mb-2 mb-sm-0 d-sm-none">
                            <div class="position-relative">
                                <button type="button"
                                    ...
                                    <img src="{{theme_asset(path: 'public/assets/front-end/img/icons/icon-i.png')}}"
                                         alt=""
                                         width="18">
                                </button>
                            ...
                            <div class="col-md-6">
                                <div class="card btn--primary h-100 position-relative">
                                    ...
                                    <img class="wallet-card-bg z-1"
                                         src="{{ theme_asset(path: 'public/assets/front-end/img/reward-card.png') }}"
                                         alt="">
                                </div>
                            </div>
                                ...
                                <div class="my-wallet-card-content h-100 text-break-word">
                                    ...
                                    <div class="mt-3 text-center d-none d-sm-block">
                                        @if ($walletStatus == 1 && $loyaltyPointStatus == 1)
                                            ...
                                            <button type="button"
                                                    data-insufficient-point="{{ translate('insufficient_loyalty_point') }}"
                                                    class="btn btn-sm rounded btn--primary {{ $loyaltyPointMinimumPoint > $totalLoyaltyPoint ? 'alert-insufficient-loyalty-point':'' }}"
                                                    @if($loyaltyPointMinimumPoint <= $totalLoyaltyPoint) data-toggle="modal"
                                                    data-target="#convertToCurrency" @endif
                                            ...
                                            >
                                                ...
                                                <span
                                                    class="font-semibold"> {{ translate('convert_to_currency') }}</span>
                                            </button>
                                        @endif
                                    </div>
                                </div>
