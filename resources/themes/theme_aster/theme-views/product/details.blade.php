                                ...
                                <div class="card-body">
                                    <div class="p-2 overlay shop-bg-card"
                                        ...
                                        <div class="media flex-wrap gap-3 p-2">
                                            <div class="avatar border rounded-circle size-3-437rem get-view-by-onclick cursor-pointer aspect-1 overflow-hidden d-flex align-items-center" data-link="{{ route('shopView',['slug' => $product->seller?->shop?->slug] ) }}">
                                                <img alt="" class="img-fit dark-support rounded-circle"
                                                    src="{{ getStorageImages(path: $product?->seller?->shop->image_full_url, type:'shop') }}">
                                            </div>
                                            <div class="media-body d-flex flex-column gap-2 text-absolute-whtie get-view-by-onclick" data-link="{{ route('shopView',['slug' => $product->seller?->shop?->slug]) }}">
