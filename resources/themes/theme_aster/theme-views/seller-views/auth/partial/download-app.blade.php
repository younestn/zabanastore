@if(isset($downloadVendorApp?->status) && $downloadVendorApp?->status)
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="text-center">
                            <img width="360" src="{{ !empty($downloadVendorApp?->image) ? getStorageImages(path:imagePathProcessing(imageData: $downloadVendorApp?->image, path: 'vendor-registration-setting'),type: 'product') : theme_asset('assets/img/media/phone.png')}}" class="dark-support" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="mt-5">
