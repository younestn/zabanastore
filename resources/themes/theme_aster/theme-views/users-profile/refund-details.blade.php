                            ...
                            <div class="modal-body">
                                <form action="#">
                                    <div
                                        ...
                                        <div class="d-flex flex-column gap-1 fs-12">
                                            <span>{{translate('Subtotal')}}: {{webCurrencyConverter($refundDetailsSummery['sub_total'])}}</span>
                                            <span>{{translate('Coupon_Discount')}}: {{webCurrencyConverter($refundDetailsSummery['coupon_discount'])}}</span>
                                            <span>{{translate('Referral_Discount')}}: {{webCurrencyConverter($refundDetailsSummery['referral_discount'])}}</span>
                                            <span>{{translate('Total_Refundable_Amount')}}: {{webCurrencyConverter($refundDetailsSummery['total_refundable_amount'])}}</span>
                                        </div>
                                    </div>
