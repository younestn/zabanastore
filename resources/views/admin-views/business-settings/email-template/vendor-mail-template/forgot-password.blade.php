<div>
    ...
    <div>
        <p>{{translate('click_here')}} <br> <a class="{{ isset($data['passwordResetURL']) ? '' : 'cursor-default'}}" href="{{$data['passwordResetURL'] ?? 'javascript:'}}">{{$data['passwordResetURL'] ?? translate('change_password')}}</a>
    </div>
    <hr>
