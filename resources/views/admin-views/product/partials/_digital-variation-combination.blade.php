                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="digital_product_price[{{ $combination['unique_key'] }}]"
                                   ...
                                   class="form-control w-max-content variation-price-input remove-symbol" required
                                   placeholder="{{ translate('ex').': 100' }}">
                        </td>
                        <td>
                            <input type="text" name="digital_product_sku[{{ $combination['unique_key'] }}]"
                                   value="{{ strtoupper($combination['sku']) }}" class="form-control w-max-content store-keeping-unit"
                                   required>
                        </td>
