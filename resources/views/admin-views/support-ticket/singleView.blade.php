                        ...
                        @foreach ($supportTicket as $reply)
                            <form class="needs-validation" href="{{ route('admin.support-ticket.replay', $reply['id']) }}"
                                ...
                                <div class="position-relative d-flex align-items-center">
                                    ...
                                    @endif
                                    <div class="w-100">
                                        <textarea class="form-control {{ theme_root_path() == 'default' ? 'ps-5' : '' }}" id="msgInputValue" name="replay"
                                            type="text" data-maxlength="189" placeholder="{{ translate('write_your_message_here') }}"></textarea>
                                        <div class="d-flex justify-content-end">
