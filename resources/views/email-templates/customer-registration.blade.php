...
<table dir="{{ $direction }}" class="main-table">
    ...
    <tr>
        <td class="main-table-td">
            <img class="mail-img-1" src='{{ dynamicAsset(path: 'public/assets/back-end/img/customer-registration.png') }}' id="logoViewer" alt="">
            ...
            <br>
            <a href="{{$data['resetRoute']}}" target="_blank" class="reset-password-btn">{{translate('reset_Password')}}</a>
            <br>
    ...
    <tr>
        <td>
            <img class="mail-img-2"
                 ...
                 id="logoViewer" alt="">
            <span class="privacy">
                    <a href="{{ route('business-page.view', ['slug' => 'privacy-policy']) }}" target="_blank"
