                    ...
                    <div class="card-body">
                        <form action="{{route('vendor.coupon.update',[$coupon['id']]) }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4 form-group">
                                    ...
                                    <select class="js-example-basic-multiple js-states js-example-responsive form-control" id="coupon_type" name="coupon_type" required>
                                        ...
                                        <option
                                            value="discount_on_purchase" {{$coupon['coupon_type']=='discount_on_purchase'?'selected':''}}>{{ translate('discount_on_purchase') }}</option>
                                        <option
                                ...
                                <div class="col-md-6 col-lg-4 form-group coupon_type">
                                    ...
                                    <select
                                        ...
                                        <option
                                            value="0" {{$coupon['customer_id']=='0'?'selected':''}}>{{ translate('all_customer') }}</option>
                                        @foreach($customers as $customer)
                                            <option
                                                value="{{ $customer->id }}" {{$coupon['customer_id']==$customer->id ? 'selected':''}}>{{ $customer->f_name. ' '. $customer->l_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 col-lg-4 form-group">
                                ...
                                <div class="col-md-6 col-lg-4 form-group free_delivery">
                                    ...
                                    <select id="discount_type" class="js-example-basic-multiple js-states js-example-responsive form-control" name="discount_type">
                                        <option
                                            value="amount" {{$coupon['discount_type']=='amount'?'selected':''}}>
                            ...
                            <div class="d-flex align-items-center justify-content-end flex-wrap gap-10">
                                <button  type="reset" class="btn btn-secondary set_btn px-4" >
                                    {{ translate('reset') }}
                                </button>
