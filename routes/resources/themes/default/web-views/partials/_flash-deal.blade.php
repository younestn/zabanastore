        ...
        <div class="flash-deals-wrapper">
            ...
            <div class="row g-3 mx-max-md-0">
                <div class="col-lg-4 px-max-md-0 flashdeal-responsive">
                    <a href="{{route('flash-deals',[$web_config['flash_deals']?$web_config['flash_deals']['id']:0])}}" class="countdown-card bg-transparent d-block">
                        <div class="flash-deal-text web-text-primary mb-3 w-100">
                            <h1 class="web-text-primary lh-1 h3 letter-spacing-0 line--limit-3 text-start mb-0">
                                <span>{{$web_config['flash_deals']->title}}</span>
                            </h1>
                        </div>
                        <div class="countdown-background text-white w-100 max-w-100 p-3">
                            <h2 class="fs-18 font-weight-normal text-white mb-4">{{translate('hurry_Up')}} ! {{translate('the_offer_is_limited')}}. {{translate('grab_while_it_lasts')}}</h2>
